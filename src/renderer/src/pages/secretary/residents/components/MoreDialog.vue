<template>
    <dialog ref="moreDialogRef" class="modal">
        ...
        <button style="font-family: satoshi" class="btn btn-ghost btn-block justify-start text-left pl-4" @click="openPurposeModal('Barangay Clearance')">
...
Barangay Clearance</button>
        <button class="btn btn-ghost btn-block justify-start text-left pl-4" @click="openPurposeModal('Certificate of Residency')">
           <svg class="w-6 h-6 text-blue-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 12 8-8 8 8M6 10.5V19a1 1 0 0 0 1 1h3v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h3a1 1 0 0 0 1-1v-8.5"/>
</svg>
 Certificate of Residency</button>
        <button class="btn btn-ghost btn-block justify-start text-left pl-4" @click="openPurposeModal('Certificate of Indigency')">
            <svg class="w-6 h-6 text-blue-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
Certificate of Indigency</button>
        <button class="btn btn-ghost btn-block justify-start text-left pl-4" @click="openPurposeModal('Certificate of Good Moral')">
            <svg class="w-6 h-6 text-blue-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
Certificate of Good Moral</button>
        <button class="btn btn-ghost btn-block justify-start text-left pl-4" @click="openPurposeModal('Certificate of Low Income')">
            <svg class="w-6 h-6 text-blue-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8H5m12 0a1 1 0 0 1 1 1v2.6M17 8l-4-4M5 8a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.6M5 8l4-4 4 4m6 4h-4a2 2 0 1 0 0 4h4a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1Z"/>
</svg>
Certificate of Low Income</button>
        <button class="btn btn-ghost btn-block justify-start text-left pl-4" @click="openPurposeModal('First Time Job Seeker')">
            <svg class="w-6 h-6 text-blue-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
First Time Job Seeker</button>
    ...
    <dialog v-if="showPurposeModal" open class="modal">
        ...
        For <strong>{{ selectedRow?.resident_name}}</strong> — {{ selectedDocument }}
      </p>
      <hr class="border-gray-200 my-4">
      <p v-if="selectedRow && selectedRow.tags !== null" class="text-xs mb-2" style="font-family: satoshi-light">
        <strong class="font-bold" style="font-family: satoshi-bold">Note:</strong> This person have the following remarks. 
      </p>
...
</div> <form method="dialog" @submit.prevent="handleSaveCerts">
