    ...
    <div class="pt-8">
        ...
        <div class="my-2 flex justify-between items-center">
            ...
            <dialog ref="myModal" class="modal">
                <div class="modal-box">
                    <h3 class="text-lg font-bold">Certificate of Residency Issuance</h3>
                    <p class="text-sm text-gray-500 mb-4">
                        Please fill out the required details to issue a certificate of residency for the resident.
                    </p>
                        ...
                        <form class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" placeholder="30" value="30" class="input input-bordered w-full"
                                        disabled />
                                </div>
                                <div>
                                    <label class="label">
                                    ...
                                    <input type="text" placeholder="30" value="Single"
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="e.g. Job application"
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="CR-2025-001" value="CR-2025-001"
                                    class="input input-bordered w-full" disabled />
                            </div>
                        </form>
                    </div>
...
export default {
    data() {
        return {
            ...
            filtered: [],
            clearances: [
                { id: 1, resident: "Adrian Bautista", purpose: "Proof of residency for voter registration", dateIssued: "2025-09-13", status: "Issued" },
                { id: 2, resident: "Clarisse Ramos", purpose: "Requirement for public school enrollment", dateIssued: "2025-09-12", status: "Issued" },
                { id: 3, resident: "Ramon Villanueva", purpose: "Supporting document for government ID application", dateIssued: "2025-09-11", status: "Pending" },
                { id: 4, resident: "Evelyn Navarro", purpose: "Verification of residence for local employment", dateIssued: "2025-09-10", status: "Issued" },
                { id: 5, resident: "Nathaniel Cruz", purpose: "Residency proof for barangay election candidacy", dateIssued: "2025-09-09", status: "Pending" },
                { id: 6, resident: "Bianca Delgado", purpose: "Requirement for business permit application", dateIssued: "2025-09-08", status: "Issued" },
                { id: 7, resident: "Patrick Salazar", purpose: "Supporting document for scholarship program", dateIssued: "2025-09-08", status: "Issued" },
                { id: 8, resident: "Monica Fajardo", purpose: "Proof of residence for utility service connection", dateIssued: "2025-09-07", status: "Pending" },
                { id: 9, resident: "Kevin Morales", purpose: "Residency requirement for police clearance", dateIssued: "2025-09-07", status: "Issued" },
                { id: 10, resident: "Jasmine Ortega", purpose: "Requirement for social welfare benefits", dateIssued: "2025-09-06", status: "Issued" },
            ],
        };
    },
    methods: {
