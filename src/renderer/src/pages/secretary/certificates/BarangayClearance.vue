<template>
  <div class="pt-8">
    ...
    <div class="my-2 flex justify-between items-center">
      ...
      <button class="btn btn-accent btn-circle" @click="openModal"><svg class="w-4 h-4 text-gray-800 dark:text-white"
      ...
      <dialog ref="myModal" class="modal">
        <div class="modal-box">
          <h3 class="text-lg font-bold">Barangay Clearance Issuance</h3>
          <p class="text-sm text-gray-500 mb-4">
            Please fill out the required details to issue a barangay clearance for the resident.
          </p>
          <div class="rounded-xl p-4">
            <form class="space-y-4">
              ...
              <div>
                ...
                <input type="text" @input="filterResidents" v-model="search" placeholder="Type to search resident..."
              ...
              <div v-if="selectedResident" class="mt-4 flex gap-2">
                ...
                <!-- If tags are present -->
                <div v-if="selectedResident.tags && selectedResident.tags.length" class="badge badge-warning">
                  <p class="my-2">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="number" placeholder="30" value="20" class="input input-bordered w-full" disabled />
                </div>
                <div>
                  <label class="label">
                    <span class="label-text">Sex</span>
                  </label>
                  <input type="text" placeholder="30" value="Male" class="input input-bordered w-full" disabled />
                </div>
              </div>
              ...
              <div>
                <label class="label">
                  <span class="label-text">Purpose of Clearance</span>
                </label>
                <input type="text" placeholder="e.g. Job application" class="input input-bordered w-full" />
              </div>
              ...
              <div>
                ...
                <input type="text" placeholder="CL-2025-001" value="CL-2025-001" class="input input-bordered w-full"
                  disabled />
              </div>
            </form>
          </div>
          <div class="modal-action ">
            <form method="dialog">
              <button class="btn btn-accent mr-2">Issue Clearance</button>
...
export default {
  data() {
    return {
      ...
      filtered: [],
      clearances: [
        { id: 1, resident: "Juan Dela Cruz", purpose: "For overseas job application", dateIssued: "2025-09-13", status: "Issued" },
        { id: 2, resident: "Maria Santos", purpose: "Enrollment requirement for college", dateIssued: "2025-09-12", status: "Issued" },
        { id: 3, resident: "Pedro Reyes", purpose: "Travel clearance for abroad", dateIssued: "2025-09-11", status: "Pending" },
        { id: 4, resident: "Ana Lopez", purpose: "Business permit registration", dateIssued: "2025-09-10", status: "Issued" },
        { id: 5, resident: "Carlos Mendoza", purpose: "Local company job hiring", dateIssued: "2025-09-09", status: "Pending" },
        { id: 6, resident: "Luisa Ramirez", purpose: "Scholarship grant application", dateIssued: "2025-09-08", status: "Issued" },
        { id: 7, resident: "Jose Fernandez", purpose: "Pre-employment document requirement", dateIssued: "2025-09-08", status: "Issued" },
        { id: 8, resident: "Isabella Cruz", purpose: "Travel pass for vacation", dateIssued: "2025-09-07", status: "Pending" },
        { id: 9, resident: "Miguel Castillo", purpose: "Business stall permit renewal", dateIssued: "2025-09-07", status: "Issued" },
        { id: 10, resident: "Sofia Gutierrez", purpose: "School entrance document", dateIssued: "2025-09-06", status: "Issued" },
