    ...
    <div class="pt-8">
        ...
        <div class="my-2 flex justify-between items-center">
            ...
            <dialog ref="myModal" class="modal">
                <div class="modal-box">
                    <h3 class="text-lg font-bold">Certificate of Good Moral Issuance</h3>
                    <p class="text-sm text-gray-500 mb-4">
                        Please fill out the required details to issue a certificate of good moral for the resident.
                    </p>
                    <div class="rounded-xl p-4">
                        <form class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="CG-2025-001" value="CG-2025-001"
                                    class="input input-bordered w-full" disabled />
                            </div>
                        </form>
                    </div>
...
export default {
    data() {
        return {
            ...
            filtered: [],
            clearances: [
                { id: 1, resident: "Juan Dela Cruz", purpose: "College admission requirement", dateIssued: "2025-09-13", status: "Issued" },
                { id: 2, resident: "Maria Santos", purpose: "Job application for local company", dateIssued: "2025-09-12", status: "Issued" },
                { id: 3, resident: "Pedro Reyes", purpose: "Application for government internship", dateIssued: "2025-09-11", status: "Pending" },
                { id: 4, resident: "Ana Lopez", purpose: "Character reference for scholarship", dateIssued: "2025-09-10", status: "Issued" },
                { id: 5, resident: "Carlos Mendoza", purpose: "Employment requirement abroad", dateIssued: "2025-09-09", status: "Pending" },
                { id: 6, resident: "Luisa Ramirez", purpose: "Transfer to another school", dateIssued: "2025-09-08", status: "Issued" },
                { id: 7, resident: "Jose Fernandez", purpose: "Teaching position application", dateIssued: "2025-09-08", status: "Issued" },
                { id: 8, resident: "Isabella Cruz", purpose: "Barangay volunteer requirement", dateIssued: "2025-09-07", status: "Pending" },
                { id: 9, resident: "Miguel Castillo", purpose: "Police clearance supporting document", dateIssued: "2025-09-07", status: "Issued" },
                { id: 10, resident: "Sofia Gutierrez", purpose: "Training program enrollment", dateIssued: "2025-09-06", status: "Issued" },
            ],
        };
    },
    methods: {
