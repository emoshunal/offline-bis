    ...
    <div class="pt-8">
        ...
        <div class="my-2 flex justify-between items-center">
            ...
            <dialog ref="myModal" class="modal">
                <div class="modal-box">
                    <h3 class="text-lg font-bold">Certificate of Low Income Issuance</h3>
                    <p class="text-sm text-gray-500 mb-4">
                        Please fill out the required details to issue a certificate of low income for the resident.
                    </p>
                        ...
                        <form class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" placeholder="30" value="Married"
                                ...
                                <div>
                                    ...
                                    <input type="text" placeholder="30" value="Tricycle Driver"
                                        class="input input-bordered w-full" disabled />
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="CL-2025-001" value="CL-2025-001"
                                    class="input input-bordered w-full" disabled />
                            </div>
                        </form>
                    </div>
...
export default {
    data() {
        return {
            ...
            filtered: [],
            clearances: [
                { id: 1, resident: "Mark Alvarez", purpose: "Scholarship grant application", dateIssued: "2025-09-13", status: "Issued" },
                { id: 2, resident: "Angela Torres", purpose: "Medical assistance from local government", dateIssued: "2025-09-12", status: "Issued" },
                { id: 3, resident: "Rolando Garcia", purpose: "DSWD financial aid requirement", dateIssued: "2025-09-11", status: "Pending" },
                { id: 4, resident: "Patricia Jimenez", purpose: "Tuition fee discount application", dateIssued: "2025-09-10", status: "Issued" },
                { id: 5, resident: "Victor Santiago", purpose: "PhilHealth indigent membership", dateIssued: "2025-09-09", status: "Pending" },
                { id: 6, resident: "Elaine Bautista", purpose: "Barangay livelihood program requirement", dateIssued: "2025-09-08", status: "Issued" },
                { id: 7, resident: "Francis Domingo", purpose: "Free legal aid qualification", dateIssued: "2025-09-08", status: "Issued" },
                { id: 8, resident: "Carla Mendoza", purpose: "Low-income housing application", dateIssued: "2025-09-07", status: "Pending" },
                { id: 9, resident: "Jerome Villanueva", purpose: "School supplies subsidy request", dateIssued: "2025-09-07", status: "Issued" },
                { id: 10, resident: "Nina Reyes", purpose: "Assistance for solo parent allowance", dateIssued: "2025-09-06", status: "Issued" },
            ],
        };
    },
    methods: {
